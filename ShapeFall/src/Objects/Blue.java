...
public class Blue extends GameObject{
	...
	public Blue(float x, float y, float width, float height, float fallSpeed, Color color, Handler handler, ObjectId id) {
	...
	public void render(Graphics g) {
		...
		if(handler.numbersEnabled()){
			g.drawImage(tex.mini[3], (int)x+2, (int)y+2, (int)width-4, (int)height-4, null);
		}
